export const products = [
  {
    ...
    variants: [
      { id: 1, size: "100ml", price: 54.00 },
      { id: 2, size: "200ml", price: 98.00 },
      { id: 3, size: "300ml", price: 140.00 },
      { id: 4, size: "400ml", price: 180.00 },
      { id: 5, size: "500ml", price: 220.00 }
    ]
  },
  {
    id: 2,
    ...
    variants: [
      { id: 1, size: "100ml", price: 38.00 },
      { id: 2, size: "200ml", price: 68.00 },
      { id: 3, size: "300ml", price: 95.00 },
      { id: 4, size: "400ml", price: 120.00 },
      { id: 5, size: "500ml", price: 145.00 }
    ]
  },
  {
    id: 3,
    ...
    icons: ["vegan", "cruelty-free", "recyclable"],
    variants: [
      { id: 1, size: "100ml", price: 28.00 },
      { id: 2, size: "200ml", price: 50.00 },
      { id: 3, size: "300ml", price: 70.00 },
      { id: 4, size: "400ml", price: 90.00 },
      { id: 5, size: "500ml", price: 110.00 }
    ]
  },
  {
    id: 4,
    ...
    icons: ["vegan", "cruelty-free", "recyclable", "gluten-free"],
    variants: [
      { id: 1, size: "100ml", price: 48.00 },
      { id: 2, size: "200ml", price: 88.00 },
      { id: 3, size: "300ml", price: 120.00 },
      { id: 4, size: "400ml", price: 150.00 },
      { id: 5, size: "500ml", price: 180.00 }
    ]
  },
  {
    id: 5,
    ...
    icons: ["vegan", "cruelty-free", "recyclable"],
    variants: [
      { id: 1, size: "100ml", price: 42.00 },
      { id: 2, size: "200ml", price: 78.00 },
      { id: 3, size: "300ml", price: 110.00 },
      { id: 4, size: "400ml", price: 140.00 },
      { id: 5, size: "500ml", price: 170.00 }
    ]
  },
  {
    id: 6,
...
export const collections = [
  {
    ...
    name: "shampoos",
    title: "Shampoos",
    description: "Cleansing products designed for hair care", 
    img: '/brooke-lark-kXQ3J7_2fpc-unsplash.jpg'
  },
  {
    id: 2,
    name: "oils",
    title: "Oils",
    description: "Nourishing oils for skin hydration and care"
  },
  {
    id: 3,
    name: "moisturizers",
    title: "Moisturizers",
    description: "Hydrating products to maintain skin moisture"
  },
  {
    id: 4,
    name: "bath-bombs",
    title: "Bath Bombs",
    description: "Effervescent products for a luxurious bath experience"
  },
  {
    id: 5,
    name: "Makeup",
    title: "Makeup",
    description: "Products designed to nourish and care for lips"
  },
  {
    id: 6,
    name: "yoni",
    title: "Yoni",
    description: "Gentle care products for intimate wellness"
  },
]; 
